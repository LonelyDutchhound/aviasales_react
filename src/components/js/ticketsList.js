...
const ticketBlock = props.tickets.map(({ price, carrier, segments: [ { origin, destination, duration, date, stops: stops1 }, { origin:origin2, destination:destination2, duration:duration2, date:date2, stops: stops2 }] }, index) => {
  const $stops1 = [];
  ...
  return (
    <li className="ticket__list-element" key={ date }>
